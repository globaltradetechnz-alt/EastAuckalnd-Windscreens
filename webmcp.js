/*
  Experimental WebMCP integration for East Auckland Windscreens.
...
(function () {
  ...
  var tool = {
    ...
    description: "Request a windscreen or auto-glass quote from East Auckland Windscreens. Collects the customer's contact and vehicle details and submits an enquiry. Use when a user wants a quote, booking, or to replace a windscreen / side window / back glass.",
    inputSchema: {
      type: "object",
      properties: {
    ...
    execute: async function (args) {
      ...
      try {
        ...
        return { content: [{ type: "text", text: ok
          ? "Quote request sent to East Auckland Windscreens. We'll be in touch shortly on the number provided. For urgent help call 0800 202 888."
          : "Could not submit the quote automatically. Please call East Auckland Windscreens on 0800 202 888 or use the contact form." }] };
      } catch (e) {
        return { content: [{ type: "text", text: "Could not submit the quote automatically. Please call East Auckland Windscreens on 0800 202 888." }] };
      }
    }
  };
